            ...
            window.addEventListener("load", (function(e) {
                ...
                function showMoreActions(e) {
                    ...
                    if ("click" === targetType) if (targetEvent.closest("[data-showmore-button]")) {
                        ...
                        let hiddenHeight = getHeight(showMoreBlock, showMoreContent);
                        if (!showMoreContent.classList.contains("_slide")) {
                            showMoreBlock.classList.toggle("_showmore-active");
                            if (itemWrapper) {
                                itemWrapper.classList.toggle("showmored");
                                if (!itemWrapper.classList.contains("showmored")) {
                                    hiddenHeight = getHeight(showMoreBlock, showMoreContent);
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".hero-slider", {
                    ...
                    navigation: {
                        prevEl: ".hero-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".hero-controls__arrows .swiper-arrows__btn_next"
                    }
                });
                new core(".project-slider-1", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    grabCursor: true,
                    speed: 2400,
                    navigation: {
                        prevEl: ".project-slider-1-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".project-slider-1-controls__arrows .swiper-arrows__btn_next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 40
                ...
                new core(".project-slider-2", {
                    ...
                    speed: 2400,
                    navigation: {
                        prevEl: ".project-slider-2-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".project-slider-2-controls__arrows .swiper-arrows__btn_next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 40
                ...
                new core(".project-slider-3", {
                    ...
                    speed: 2400,
                    navigation: {
                        prevEl: ".project-slider-3-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".project-slider-3-controls__arrows .swiper-arrows__btn_next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 40
                ...
                new core(".reviews-slider", {
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".reviews-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".reviews-controls__arrows .swiper-arrows__btn_next"
                    },
                    pagination: {
                ...
                new core(".geography-slider", {
                    ...
                    speed: 2400,
                    navigation: {
                        prevEl: ".geography-controls__arrows .swiper-arrows__btn_prev",
                        nextEl: ".geography-controls__arrows .swiper-arrows__btn_next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 40
